...
Essa complexidade nos metadados dos posts acaba dificultando a escrita e a exportação dos post. Para contornar esse problema e criar um blog amigável para exportações resolvi escrever meu próprio gerador.
