...
Suspeitando que os dados fossem os mesmos hackeados do CADSUS fui ver se eu estava lá. Os dados expostos através dele não pareciam ser diferentes dos expostos no hack do CADSUS, a principal diferença era o endereço de email.
